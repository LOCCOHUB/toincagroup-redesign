const Services = () => {
  const serviceItems = [
    ...
    {
      icon: (
        <svg className="h-10 w-10 text-cyan-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    ...
    },
    {
      ...
      description: 'Servicio técnico con garantía. Disponemos de taller propio y técnicos especializados que se desplazan hasta sus instalaciones.',
    },
  ];
      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="mt-12 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          {serviceItems.map((service, index) => (
            ...
            >
              <div className="mb-4 flex h-16 w-16 items-center justify-center rounded-full bg-blue-50 group-hover:bg-blue-100">
                {service.icon}
              </div>
        ...
        <div data-aos="fade-up" className="mx-auto mt-12 max-w-xl text-center">
          <div className="inline-flex rounded-md shadow-sm">
            <a
              ...
              className="inline-flex items-center justify-center rounded-lg bg-white px-6 py-3 text-base font-medium text-blue-600 shadow-sm ring-1 ring-blue-600 transition-colors hover:bg-blue-50 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-offset-2"
            >
              Ver más servicios
              <svg
